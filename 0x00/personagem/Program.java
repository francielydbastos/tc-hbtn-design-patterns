public class Program {
    public static void main(String[] args) {
        ...
        try {
            Personagem guerreiroInvalido = new Guerreiro("personagem.Guerreiro Invalido", 8, 3, 3, 3, 4);
        ...
        try {
            Personagem magoInvalido = new Mago("personagem.Mago Invalido", 1, 8, 7, 7, 10);
